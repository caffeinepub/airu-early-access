      ...
      <main className="max-w-3xl mx-auto px-6 py-20">
        <motion.div variants={stagger} initial="hidden" animate="visible">
          ...
          >
            ...
            >
              Reserve Your LumaAir <ArrowRight className="w-4 h-4" />
            </a>
          </motion.div>
        </motion.div>
      </main>
